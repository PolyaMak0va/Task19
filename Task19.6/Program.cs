...
namespace Task19._6
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Computer> сomputers = listComputer;
            bool hasElements = сomputers.Any(c => c.Copies >= 30);
            Console.WriteLine("В базе данных марки ноутбуков в количестве не менее 30 шт. {0} ", hasElements ? "есть" : "нет");
            Console.ReadKey();
        }
    }
}
